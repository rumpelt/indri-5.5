...
public:
  ...
  static std::vector<std::string> whiteSpaceSplit(std::string& inputSource, std::unordered_set<std::string> stopSet, bool lower=true, unsigned charLimit=0);
  static std::vector<std::string> tokenize(std::string& inputSource, bool lower, std::unordered_set<std::string>& stopwords, unsigned int charLimit=0);
